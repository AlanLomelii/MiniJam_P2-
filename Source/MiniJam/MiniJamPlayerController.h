 ...
 */
UCLASS(abstract)
class MINIJAM_API AMiniJamPlayerController : public APlayerController
{
	GENERATED_BODY()
...
protected:
	...
	TObjectPtr<AMiniJamPawn> VehiclePawn;

	/** Type of the UI to spawn */
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = UI)
	TSubclassOf<UMiniJamUI> VehicleUIClass;

	/** Pointer to the UI widget */
	TObjectPtr<UMiniJamUI> VehicleUI;
