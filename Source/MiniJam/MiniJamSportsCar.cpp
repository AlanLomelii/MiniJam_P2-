...
#include "MiniJamSportsCar.h"
#include "MiniJamSportsWheelFront.h"
#include "MiniJamSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AMiniJamSportsCar::AMiniJamSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UMiniJamSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UMiniJamSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UMiniJamSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UMiniJamSportsWheelRear::StaticClass();
